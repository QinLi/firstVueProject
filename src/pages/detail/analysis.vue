...
<div class="sales-board">
      ...
      <my-dialog :is-show="isPayDialogShow" @on-close="hidePayDialog">
      ...
      <check-order :is-show-check-dialog="isShowCheckOrder" @on-close-check-dialo="hideCheckOrder"></check-order>
  </div>
</template>
